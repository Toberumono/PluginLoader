...
/**
 * Thrown when attempting an operation that requires a {@link ManageablePlugin plugin} to be linkable on a
 * {@link ManageablePlugin plugin} that is not linkable.
 *
 * @author Toberumono
 */
public class UnlinkablePluginException extends PluginException {
	 ...
	 */
	public UnlinkablePluginException() {
		super();
	}
	 ...
	 */
	public UnlinkablePluginException(String message) {
		super(message);
	}
	 ...
	 */
	public UnlinkablePluginException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 *            permitted, and indicates that the cause is nonexistent or unknown.)
	 */
	public UnlinkablePluginException(Throwable cause) {
		super(cause);
	}
}
