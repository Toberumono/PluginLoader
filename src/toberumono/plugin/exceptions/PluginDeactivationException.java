...
/**
 * Thrown when deactivating a plugin fails (generally by the {@link PluginUser#deactivatePlugin} method).
 *
 * @author Toberumono
 */
public class PluginDeactivationException extends PluginInitializationException {
	 ...
	 */
	public PluginDeactivationException() {
		super();
	}
	 ...
	 *            permitted, and indicates that the cause is nonexistent or unknown.)
	 */
	public PluginDeactivationException(Throwable cause) {
		super(cause);
	}
}
